...
mcs -target:library -r:System.Drawing.dll -r:System.Windows.Forms.dll -out:DoublePinballui.dll DoublePinballui.cs

# Compiling the driver file and linking with created dlls to create an executable
mcs -r:System -r:System.Windows.Forms -r:DoublePinballui.dll -out:DoublePinball.exe DoublePinballmain.cs
